...
Optimizing the transaction processing procedure and related components is the key for improving the throughput rate for the overall system. For this purpose, Rooch utilize a pipeline structure to achieve parallel transaction execution.
...
The proposer execute all the transactions in a block in parallel, utilizing a simlar approach introduced by [BlockSTM](https://arxiv.org/abs/2203.06871).
