...
The importance of DA (Data Availability) is to ensure anyone can get access to all the transactions that happened in the off-chain environment.

Rooch Network will adopt a third-party solution to ensure the availability of the transactions and maintain a high TPS. We are still researching different candidates, which include [Celestia](https://celestia.org/), [Eigenlayer](https://www.eigenlayer.xyz/), [Polygon Avail](https://polygon.technology/blog-tags/polygon-avail), and [Arweave](https://www.arweave.org/).
