...
- [#321](https://github.com/rooch-network/rooch/pull/321) 修复了在 `AccessPath` 中使用短十六进制字符串时出错，参见 [#284](https://github.com/rooch-network/rooch/pull/284)。
- 在 [#337](https://github.com/rooch-network/rooch/pull/337) 中修复了 `rooch move build` 返回错误消息的问题，参见 `#336`，删除 `example/private_generics` 目录中失败的 `private_generics` 示例。
