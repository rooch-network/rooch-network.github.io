    ...
    <footer class="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      <div class="text-center">
        <div class="mt-3 space-x-2">
          <a class={buttonStyle} href="https://github.com/rooch-network/">
            <svg
              class="w-3.5 h-3.5"
          ...
          <a class={buttonStyle} href="https://twitter.com/RoochNetwork">
            <svg
              class="w-3.5 h-3.5"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <a class={buttonStyle} href="https://discord.gg/rooch">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a class={buttonStyle} href="https://medium.com/rooch-network">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
