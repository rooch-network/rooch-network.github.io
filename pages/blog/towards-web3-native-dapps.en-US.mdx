...
In the Hybrid Web3 model, the ownership of data, functions, and assets are totally in the hands of the server operator (sometimes the cloud server provider). So society consensus based trust is the only security mechanism here.
