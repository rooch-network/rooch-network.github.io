...
On each Layer1, there will be 2 functional smart contracts:

- Bridge contract is in charge of managing all the states and assets that are to be migrated to or from a Rooch instance in the execution layer.
- Cross-Chain Message contract is used to communicate with Ethereum to verify
