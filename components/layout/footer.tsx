...
export function Footer() {
  ...
  useEffect(() => {
    if (pathname == "/" || pathname == "/about" || pathname == "/blog") {
    ...
    <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div className="text-center grid grid-cols-2">
        ...
        <div className="mt-3 space-x-2 text-right">
          ...
          <a className={buttonStyle} href="https://twitter.com/RoochNetwork">
            <svg
              className="w-3.5 h-3.5"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
          ...
          <a className={buttonStyle} href="https://discord.gg/rooch">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
          ...
          <a className={buttonStyle} href="https://medium.com/rooch-network">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
