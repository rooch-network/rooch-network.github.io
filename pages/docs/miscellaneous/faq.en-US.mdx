...
In this document you can find answers to several questions we have frequently been asked to.

## How do you compare Rooch with other similar projects?

![Key Innovations](/docs/key-innovations.png)

## What's the status quo of the Rooch project?
...
Rooch will support multiple Move L1 Framework and we have made preliminary progress in the combination of Object Move and Global Storage Move . We will make efforts towards building compatibility with both Aptos-Move and Sui-Move.
